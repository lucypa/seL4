...
/** DONT_TRANSLATE */
static inline void NORETURN FORCE_INLINE fastpath_signal_restore(word_t badge, tcb_t *cur_thread) {
    NODE_UNLOCK;
    ...
    register word_t cur_thread_reg asm("x1") = (word_t)cur_thread->tcbArch.tcbContext.registers;
